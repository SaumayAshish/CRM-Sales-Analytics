...
4. **No marketing automation.** Explicitly excluded per the 7-module lock in `CLAUDE.md`. Including it would dilute focus and risk under-delivering on the core sales-process modules that are the actual project thesis.
